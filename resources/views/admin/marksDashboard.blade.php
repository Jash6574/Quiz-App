        ...
        @php $x = 1; @endphp
            @foreach($exams as $exam)
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info editMarks" data-id="{{ $exam->id }}" data-marks="{{ $exam->marks }}" data-totalq="{{ count($exam->getQnaExam) }}" data-toggle="modal" data-target="#editMarksModal">Edit</button>
                    </td>
            ...
            <form id="editMarks">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            name="marks" id="marks" placeholder="Enter Marks" min="0" required>
                        </div>
                    </div>
