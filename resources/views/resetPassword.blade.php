...
<head>
    ...
    <title>Reset Password | QuizzUP</title>
</head>
<body>
...
<input type="password" name="password_confirmation" placeholder="Enter Confirm Password" required><br>
<input type="submit" value="Reset Password" class="btn-grad">
